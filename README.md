...
- 功能三 : 玩家可以在交易所以 NOXCAT 或裝備向指定玩家發起贈與／雙向交換，亦有機會與失散的寵物在許久之後重聚
...
本專案原始碼採用 [MIT License](LICENSE) 進行授權。

> **注意**：專案中所包含之 NOXCAT 官方 IP 角色圖樣、商標與相關標識，其智慧財產權仍歸原所有者所有，僅限於本屆黑客松活動之展示與評選使用，不包含在 MIT 開源授權範圍內。詳情請參閱 [第三方服務、資料與素材](#第三方服務資料與素材) 說明。
