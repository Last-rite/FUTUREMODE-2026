...
我們參加 AI X CREATIVITY 賽道，結合 NOXCAT 官方IP素材，創作一款使用手機遊玩的可觸控式網頁小遊戲，提供給 NOXCAT 用戶遊玩，我們期望，透過這種「角色獨一無二且有可能遺失」的特性，使玩家必須跟其他使用者交流，進而增加玩家間的互動性，並利用此遊戲提升玩家對於NOXCAT App的依賴性。
...
5. **豐富化關卡機制與養成系統（Combat Depth & Progression）**
   ...
   - 引入火、水、木屬性相剋機制與角色終極奧義（Strike Shot），深化彈射策略性。
